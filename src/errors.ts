// Typed error classes — PUSH-REORGANIZATION §3.4.
//
...
//                                distinguish — see PUSH-REORG §7.3)
//
// Migration policy (PUSH-REORG §7.2): zero-cycle. New code throws
...
// PUSH-REORG §7.4 decided to model both as one class; catch sites
