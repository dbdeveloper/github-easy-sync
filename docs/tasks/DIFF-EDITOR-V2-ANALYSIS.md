...
- [ ] `diff-pane.ts`: зібрати view — `structureField` + decorations-field + filters ((b) auto-`\n` `§2.2.4(2)`,
      (c) зовнішні guard-и `§2.2.5`, (d) selection-legalization `§2.2.6`) + `cursorVert` keymap (`Prec.highest`).
