...
- [ ] **Лишилось:** keyboard-hotkeys §1.9 (Ctrl+Enter тощо → resolve поточної групи) + bulk-toolbar
      (`[Keep all RED]`/`[Apply all GREEN]`/`[Join all]`); кнопкові мітки/кольори §1.11 + capitalize (TODO #6) — CSS.
