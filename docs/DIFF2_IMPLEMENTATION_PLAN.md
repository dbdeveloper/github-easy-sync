...
- Кнопка прихована або disabled, якщо у списку немає markdown-конфліктів, щоб не
  ...
  конфліктів, залишаться тільки (якщо є) файли інших типів і кнопка [Join all changes] стане disabled, aбо буде прихована.
...
*Auto-resolve T2 (R4)*: якщо користувач створює файл `note.md` у vault вручну і він стає байт-рівним sibling-у — конфлікт
