// Perf-only helpers. The perf tests import integration helpers
// (createSync2Client / sync2AllAndAssertNoErrors / branch lifecycle)
// directly from `../integration/scenarios/sync2/helpers` and
// `../integration/helpers`. This module's job is to print baseline
// records in a shape that's grep'able from the terminal AND
// parseable by a future "compare two runs" script.
//
